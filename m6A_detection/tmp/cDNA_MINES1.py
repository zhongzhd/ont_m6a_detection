...
drach_seqs=['AAACA','AAACC','AAACT','AGACA','AGACC','AGACT','GAACA','GAACC','GAACT','GGACA','GGACC','GGACT']
...
df=df[(df['pos']==0)&(df['drach_kmer'].isin(['AAACA','AAACC','AAACT','AGACA','AGACC','AGACT','GAACA','GAACC','GAACT','GGACA','GGACC','GGACT']))&(df['coverage']>=5)]
